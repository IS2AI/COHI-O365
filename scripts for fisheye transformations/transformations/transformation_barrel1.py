...
def barrel(filename, file_path, output_dir, c, scaling_factor, a, b, name_end):
...
for filename in os.listdir(directory):
    ...
    try:
        barrel(filename, file_path, 'patch0_labels_barrel1/', 0.25, scaling_factor, 0.08, 0.045, '_barrel1')   #change output dir!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
